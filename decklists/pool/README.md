...
- Five lists were tuned in September 2026 (with the user's approval) to bring within-tier balance into 15-35% under the look-ahead AI: Meren and Atraxa were trimmed, Brago, Marwyn and Yawgmoth strengthened. Each file's notes list the swaps; the old lists are in git history.
