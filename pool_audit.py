...
MECH = {
    ...
    'helm_of_the_host': ('Full', 'hasty token copy each combat; the Combat Celebrant loop is a combo (see combos)'),
    ...
    'put_attacking': ('Approximate', 'Kaalia: best Angel/Demon/Dragon from hand, attacking; Winota: see Tier 5'),
    ...
    'counter_ai': ('Partial', 'outside decks counter by importance; combo pieces weighted from Tier 3 on'),
    'yawgmoth':          ('Unmodeled', ''),
