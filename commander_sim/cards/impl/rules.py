...
def _jwom_ult(g, p, src):
    draw(g, p, 7)
    if not p.library: from commander_sim import ais; ais.win(g, p, 'Jace')
...
def evasion_blocked(g, b, a):
    ...
    if importlib.import_module('commander_sim.cards.impl.rules2').prot_unblockable(g, b, a): return True
