...
from commander_sim.cards.impl.common import make_artifact_tokens, sac_food, proliferate, walker, always, best_opp_creature, best_opp_nonland
...
def _vraska_plus(g, p, src):
    ...
    if fod: die(g, min(fod, key=lambda m: pval(g, m)), 'sac'); gain(p, 1); draw(g, p, 1)
        ...
        from commander_sim.cards.impl import t3 as impl_t3; impl_t3.sac_worst_permanent(g, p, src); gain(p, 1); draw(g, p, 1)
