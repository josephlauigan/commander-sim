...
from commander_sim.cards.impl.common import make_artifact_tokens, best_opp_creature, best_opp_nonland, walker, always
from commander_sim.cards.impl.t2 import best_target_any, blink, blink_value
...
def _rhythm(g, p, c, ctx):
    from commander_sim.cards.impl import t3 as impl_t3; impl_t3._put_creature(g, p, lambda y: y.cmc <= ctx.get('x', 0))
