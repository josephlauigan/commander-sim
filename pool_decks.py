...
CONFIG = {
    ...
    'yawgmoth-mono-black-aristocrats': {'wish': lambda g, p, *a: __import__('deck_plans').yawg_wish(g, p),
                                        'prio_fn': lambda g, p, c: __import__('deck_plans').yawg_prio(g, p, c)},
    ...
    'heliod-mono-white-stax': {'prio_fn': lambda g, p, c: __import__('deck_plans').heliod_prio(g, p, c),
                              'wish': lambda g, p, *a: __import__('deck_plans').heliod_wish(g, p),
